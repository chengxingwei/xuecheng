...
import com.xuecheng.member.component.AccessDecisionManagerImpl;
import com.xuecheng.member.component.AccessDeniedHandlerImpl;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(
                        ...
                        "/swagger-ui.html","/course/coursebase/**","/webjars/springfox-swagger-ui/**").permitAll()
                .anyRequest().authenticated()
